...
const player = () => {
    ...
    useEffect(() => {
        if (audioRef.current && song?.url) {
            ...
            // Try to auto-play (browsers may block this without user interaction, but since they clicked detect it might work)
    ...
    return (
        <div className={`player ${!song ? 'player--empty' : ''}`}>
            {song ? (
                <>
                    <audio
                        ref={audioRef}
                ...
                <div className="player__placeholder">
                    {loading ? (
                        <p>Searching for the perfect track...</p>
                    ) : (
                        <p>Detect your expression to play music...</p>
                    )}
                </div>
            )}
        </div>
